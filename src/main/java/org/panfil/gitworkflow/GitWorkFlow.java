package org.panfil.gitworkflow;

public class GitWorkFlow {
    public static void main(String[] args) {

        String step1 = "Perform git stash - store the uncomitted changes";
        ...
        String step3a = "Perform git pull command - to fetch and download content from the origin/master and immediately update the local master to match the content";
        ...
        String step5 = "Add your changed and check your code before commiting them";
        ...
        String step14 = "In case of commit amend then a git force should be performed in order to update the remote branch and existing Pull Request";
        String step15 = "After that,the origin/master contains the latest changes and the origin/new_branch_name can be deleted";
        String step16 = "Do not forget that locally you are still on the new_branch_name, its good to move back to master";
